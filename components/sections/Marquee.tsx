export function Marquee() {
  const row1 =
    'FULLSTACK ENGINEER ✦ AI SAAS ARCHITECT ✦ NEXT.JS · TYPESCRIPT ✦ ANTHROPIC SDK ✦ REAL ESTATE TECH ✦ FULL-STACK ENGINEER ✦ MLOPS CERTIFIED ✦ OPEN TO SELECT PROJECTS ✦ BUILDING IN PORTUGAL 🇵🇹 ✦ SHIPPING TO BRAZIL 🇧🇷 ✦ '
